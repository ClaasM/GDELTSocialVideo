...
CREATE TABLE IF NOT EXISTS FoundVideos (
...
CREATE INDEX articles_crawling_status_index
  ON Articles (crawling_status);
CREATE INDEX articles_mention_source_name_index
  ON Articles (mention_source_name);
CREATE INDEX found_videos_platform_index
  ON FoundVideos (platform);
CREATE INDEX found_videos_video_url_index
  ON FoundVideos (video_url);
CREATE INDEX found_videos_video_id_index
  ON FoundVideos (video_id);
