...
"""
Source: https://github.com/wardbradt/HTMLST
(modified)
"""
...
# elements which may not contain children and denote the end of a sentence
EMPTY_ELEMENTS = {'area', 'base', 'br', 'embed', 'hr', 'img', 'input', 'source', 'link'}
